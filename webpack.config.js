...
module.exports = {
	...
	plugins: [
		...
		new webpack.optimize.CommonsChunkPlugin('vendors', 'js/lib/vendors.[hash].js'),
		...
		/*打包后index.html包含app.css(bootstrap.css/main.css)+vendors.css(index.scss/variable.scss); 
		mobile.html仅包含vendors.css。如new HtmlwebpackPlugin的chunks有公共模块，则webpack打包时会抽取公共样式并以其名称命名，否则无*/
